...
export const meta: MetaFunction = () => {
  return [
    { title: 'Michelin | Polyglot AI App Generator powered by Elide + Convex' },
    { name: 'description', content: 'Generate full-stack polyglot apps with Michelin, powered by Elide and Convex' },
    {
      property: 'og:image',
