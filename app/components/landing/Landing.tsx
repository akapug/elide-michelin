    ...
    <div className="my-12 flex max-w-chat flex-col">
      <div className="overflow-hidden rounded-lg border border-neutral-2 dark:border-neutral-10">
        ...
        <div className="flex flex-col gap-6 px-4 py-6 text-lg text-neutral-9 dark:text-neutral-2">
          <p>
            Michelin is open-source, check out the GitHub repo{' '}
            <a
              href="https://github.com/akapug/elide-michelin"
          ...
          <p>
            ...
            Michelin, you can view or download the system prompt{' '}
            <a
              href="https://github.com/akapug/elide-michelin/releases/latest"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
              here
            </a>
          ...
          <p>
            As mentioned above, Michelin&apos;s capabilities are enabled by being built on top of{' '}
            <a
              href="https://convex.dev"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
            ...
            &ldquo;magic&rdquo; in Michelin is just the fact that it&apos;s using Convex&apos;s APIs, which are an ideal fit
            for codegen.
          </p>
          <p>
            Michelin is supercharged by{' '}
            <a
              href="https://github.com/elide-dev/elide"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
            ...
            , the polyglot runtime that enables true multi-language app generation. We{' '}
            <a
              href="https://github.com/akapug/elide-michelin/blob/main/CONTRIBUTING.md"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
              welcome bug fixes
            </a>{' '}
